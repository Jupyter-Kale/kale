...
%     \begin{tabular}{llll}
%         \toprule
%         Test & Exploration & Narrative & Interactivity \\
%         \midrule
%         Jupyter &
%         \parbox{.33\linewidth}{
%         \begin{itemize}
%         \item Freedom to write anything
%         \item Reusable code cells
%         \item Build something, modify it easily, try again, repeat. 
%         \item Easy to develop something, then easy to paste it into a python script or continue running it directly from the notebook. 
%         \end{itemize}} &
% 
%         \parbox{.33\linewidth}{
%         \begin{itemize}
%         \item Markdown, LaTeX, code all together
%             \item Tell the full story all in one place
%             \item Cohesive way to communicate complex ideas
%         \end{itemize}} &
% 
%         \parbox{.33\linewidth}{
%         \begin{itemize}
%         \item Widgets - sliders, text input, controllers, etc.
%         \item Allow you to interact directly with data and models
%         \item Visualization and experimentation
%         \end{itemize}} \\
% 
%         Kale &
%         \parbox{.33\linewidth}{
%         \begin{itemize}
%         \item Easily create workflows from the ground up. Start with one notebook and expand to two. Add some C++. etc.
%         \end{itemize}} &
% 
%         \parbox{.33\linewidth}{
%         \begin{itemize}
%         \item Rich descriptions for workflows and notebooks
%         \item Communicate full HPC workflows 
%         \item Provenance, reproducibility
%         \end{itemize}} &
% 
%         \parbox{.33\linewidth}{
%         \begin{itemize}
%         \item Monitor HPC jobs as they're running
%         \item Interactive notebooks as workflow steps
...
% \subsection{What do I really mean?}\label{what-do-i-really-mean}
% 
...
%   \end{itemize}
% \item
%   Easy to develop something, then easy to paste it into a python script
%   or continue running it directly from the notebook.
% \end{itemize}
% 
% \subsubsection{Narrative}\label{narrative-1}
% 
% \begin{itemize}
% \tightlist
% \item
...
% \end{itemize}
% 
% \subsection{Kale}\label{kale}
% 
% \subsubsection{Exploration}\label{exploration-2}
% 
% \begin{itemize}
% \tightlist
% \item
%   Easily create workflows from the ground up. Start with one notebook
%   and expand to two. Add some C++. etc.
% \end{itemize}
% 
% \subsubsection{Narrative}\label{narrative-2}
% 
% \begin{itemize}
% \tightlist
% \item
...
% \end{itemize}
% 
% \subsubsection{Interactivity}\label{interactivity-2}
% 
% \begin{itemize}
% \tightlist
% \item
